...
public final class CruiseHud {
    ...
    public static void render(GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        renderHud(graphics, minecraft.font, vehicle, route, graphics.guiWidth(), graphics.guiHeight());
    }
    ...
    private static void renderHud(GuiGraphics graphics, Font font, VehicleEntity vehicle, boolean boosting,
        ...
        graphics.drawString(font, "燃料剩余时间 " + formatTime(fuelInfo.remainingTicks()), x, y + 42, 0xFFFFFFFF, true);
        graphics.drawString(font, "飞行剩余时间 " + formatTime(flightRemainingTicks), x, y + 52, 0xFFFFFFFF, true);
        int detailsY = y + 64;
